...
{
  int size, rank;
  MPI_Comm_size(dmd_comm, &size);
  MPI_Comm_rank(dmd_comm, &rank);
  if(!rank) {
    cout << endl;
    cout << "\033[0;38;5;162m   .----------------.   .----------------.   .----------------.    \033[0m" << endl;
    cout << "\033[0;38;5;162m  | .--------------. | | .--------------. | | .--------------. |   \033[0m" << endl;
    cout << "\033[0;38;5;162m  | |  ________    | | | | ____    ____ | | | |  ________    | |   \033[0m" << endl;
    cout << "\033[0;38;5;162m  | | |_   ___ `.  | | | ||_   \\  /   _|| | | | |_   ___ `.  | |   \033[0m" << endl;
    cout << "\033[0;38;5;162m  | |   | |   `. \\ | | | |  |   \\/   |  | | | |   | |   `. \\ | |   \033[0m" << endl;
    cout << "\033[0;38;5;162m  | |   | |    | | | | | |  | |\\  /| |  | | | |   | |    | | | |   \033[0m" << endl;
    cout << "\033[0;38;5;162m  | |  _| |___.' / | | | | _| |_\\/_| |_ | | | |  _| |___.' / | |   \033[0m" << endl;
    cout << "\033[0;38;5;162m  | | |________.'  | | | ||_____||_____|| | | | |________.'  | |   \033[0m" << endl;
    cout << "\033[0;38;5;162m  | |              | | | |              | | | |              | |   \033[0m" << endl;
    cout << "\033[0;38;5;162m  | '--------------' | | '--------------' | | '--------------' |   \033[0m" << endl;
    cout << "\033[0;38;5;162m   '----------------'   '----------------'   '----------------'    \033[0m" << endl;
    cout << endl;
  ...
  //MPI_Barrier(dmd_comm); //not friendly to concurrent programs
  //
  return;
}
